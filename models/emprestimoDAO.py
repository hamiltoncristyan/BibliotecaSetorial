class Emprestimo:
    ...
    def inserir(self, emprestimo):
        ...
        try:
            sql = "INSERT INTO emprestimo (exemplar_id_exemplar, usuario_matricula, emprestimo_id, data_emprestimo, data_devolucao) VALUES (%s, %s, %s, %s, %s)"
            cursor = self.con.cursor()
            cursor.execute(sql, (emprestimo.exemplar_id_exemplar, emprestimo.usuario_matricula, emprestimo., funcionario.senha, funcionario.tipo))
