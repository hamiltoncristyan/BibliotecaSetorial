class LivroDAO:
    ...
    def inserir(self, livro):
        ...
        try:
            sql = "INSERT INTO livro (nome, autor, quantidade_pag, area_id_area, link_capa, descricao) VALUES(%s, %s, %s, %s, %s, %s)"
            cursor = self.con.cursor()
            cursor.execute(sql, (livro.nome, livro.autor, livro.quantidade_pag, livro.area_id_area, livro.link_capa, livro.descricao))
